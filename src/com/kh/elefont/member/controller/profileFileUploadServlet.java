...
public class profileFileUploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		/**
		 * 1. 파일업로드(사용자파일을 서버컴퓨터에 저장) : MultipartRequest객체 생성 a. HttpServletRequest b.
		 * saveDirectory 파일이 저장될 directory c. maxPostSize 업로드 최대용량(10mb) d. encoding e.
		 * FileRenamePolicy객체 : DefaultFileRenamePolicy객체 -> MvcFileRenamePolicy객체
		 * 
		 * 
		 * 2. 저장된 파일정보를 db에 저장
		 * 
